...
export default function Landing() {
    ...
    return (
        <div className="flex flex-col min-h-screen" style={{ backgroundImage, backgroundSize: "cover" }}>
            ...
            <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t border-purple-400 bg-primary/50">
                <p className="text-sm text-white">©{" "}
                    {new Date().getFullYear()} DubJam. All rights reserved.</p>
                <nav className="sm:ml-auto flex gap-4 sm:gap-6">
                    <p>
                        Made with <span className="text-red-500">❤</span> for {" "}
                        <a href="https://dubhacks.co" className="text-primary underline text-white">
                            DubHacks'
                        </a>
                        {" "}
                        10th Anniversary
                ...
                <div className="flex flex-col items-center space-y-4 text-center">
                    ...
                    >
                        <div className="overflow-hidden">
                            <motion.h1 className="text-5xl text-white dark:text-inherit font-bold sm:text-6xl md:text-7xl lg:text-9xl/none mb-2" variants={itemVariants}>
                                Make Music
                            </motion.h1>
                        </div>
                        <div className="overflow-hidden">
                        ...
                        <motion.h1 className="text-5xl text-white dark:text-inherit font-bold sm:text-6xl md:text-7xl lg:text-9xl/none" variants={itemVariants}>
                            With Anyone.
                        </motion.h1>
                    ...
                    <div className="space-y-4 flex gap-4 flex-col pt-8">
                        ...
                        >
                            DubJam is an online music production platform that lets you create, share, and collaborate on making music with friends, all in <span className="underline">
                                real-time.
                            </span>
                        </motion.p>
                        <motion.div
